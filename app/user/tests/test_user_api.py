...
class PublicUserApiTests(TestCase):
    ...
    def test_create_token_for_user(self):
        ...
        payload = {'email': 'test@adevlab.com', 'password': 'testpass'}
        create_user(**payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='test@adevlab.com', password='testpass')
        payload = {'email': 'test@adevlab.com', 'password': 'wrong'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_missing_fields(self):
        ...
        res = self.client.post(
            TOKEN_URL, {'email': 'one@adevlab.com', 'password': ''})
        self.assertNotIn('token', res.data)
        self.assertEqual(res.status_code, status.HTTP_400_BAD_REQUEST)
...
class PrivateUserApiTests(TestCase):
    ...
    def test_update_user_profile(self):
        ...
        payload = {'name': 'new name', 'password': 'newpassword2345'}
